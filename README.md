...
- Approved portable continuity facts can be inspected and deliberately authored with source-preserving guards, but timelines and deterministic continuity checks are not implemented yet; the researched timeline/calendar contract is awaiting format approval in [`docs/TIMELINE_FORMAT.md`](docs/TIMELINE_FORMAT.md)
