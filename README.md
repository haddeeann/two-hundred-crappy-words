...
- Continuity facts and checks are not implemented yet; the researched portable fact contract is awaiting review in [`docs/CONTINUITY_FORMAT.md`](docs/CONTINUITY_FORMAT.md)
