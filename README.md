...
- Approved portable continuity facts can be inspected and deliberately authored with source-preserving guards, and the approved timeline/calendar file now has a bounded parser and published schema; calendar calculations, the timeline interface, and deterministic continuity checks are not implemented yet; see [`docs/TIMELINE_FORMAT.md`](docs/TIMELINE_FORMAT.md)
