...
- Approved portable continuity facts can be inspected and deliberately authored with source-preserving guards; the approved timeline/calendar file has a bounded parser and published schema, and Gregorian/fixed/ordinal expressions normalize into precision-preserving ranges; the timeline interface and deterministic continuity checks are not implemented yet; see [`docs/TIMELINE_FORMAT.md`](docs/TIMELINE_FORMAT.md)
