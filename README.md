...
- Manuscript structure can be inspected, initially created/imported, repaired after a uniquely identified source move, and edited for descriptive chapter/scene details, but path-only replacement, reordering, corkboard views, counts, and compile/export are still in progress
