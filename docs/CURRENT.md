...
- The static accessibility audit hides decorative glyphs, exposes active/selected tree state, provides at least 24×24 px window-control targets, and verifies representative text contrast from 5.85:1 to 11.25:1 plus focus contrast above 7.7:1. Native focus order and announcements remain in the human checkpoint.
