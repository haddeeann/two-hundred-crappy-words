...
- [ ] Add structured canon status and typed worldbuilding properties. The approved format, schema, parser/index foundation, property registry, read-only inspector, and preservation-safe mutation planners are complete; guarded authoring UI and execution remain.
